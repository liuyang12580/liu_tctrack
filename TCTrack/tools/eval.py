...
from toolkit.datasets import UAV10Dataset,UAVDataset,UAVTrack112lDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tracker_prefix',default='', nargs='+')
    ...
    #                               args.dataset,
    #                               args.tracker_prefix+'*'))
    trackers = glob(os.path.join(args.tracker_path,args.dataset,'checkpoint00_e24.pth'))
